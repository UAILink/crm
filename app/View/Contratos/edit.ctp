...
<div class="row">
    ...
    <div class="span4" >
        ...
        <li class='nav-header'><?php echo __('Ações'); ?></li>
        		        ...
        		        <li><?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('Contrato.id')), array('class'=>''), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('Contrato.id'))); ?></li>
