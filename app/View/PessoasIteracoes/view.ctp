...
<div class="span4" >
    ...
    <ul class="nav nav-list">
      <li class='nav-header'><?php echo __('Ações'); ?></li>
		...
		<li><?php echo $this->Html->link(__('Editar Pessoas Iteração'), array('action' => 'edit', $pessoasIteracao['PessoasIteracao']['id']), array('class'=>'ym-button')); ?></li> 
		<li><?php echo $this->Form->postLink(__('Excluir Pessoas Iteração'), array('action' => 'delete', $pessoasIteracao['PessoasIteracao']['id']), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $pessoasIteracao['PessoasIteracao']['id'])); ?></li> 
		<li><?php echo $this->Html->link(__('Listar Pessoas Iterações'), array('action' => 'index'), array('class'=>'ym-button')); ?></li> 
		<li><?php echo $this->Html->link(__('Novo Pessoas Iteração'), array('action' => 'add'), array('class'=>'ym-button')); ?></li> 
