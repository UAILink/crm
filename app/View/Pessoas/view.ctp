...
<div class="ym-col3" >
    <div class="actions ym-cbox">    
      <h6><?php echo __('Ações'); ?></h6>
		...
		<?php echo $this->Form->postLink(__('Excluir Pessoa'), array('action' => 'delete', $pessoa['Pessoa']['id']), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $pessoa['Pessoa']['id'])); ?> 
...
<?php echo __('<h6>Tipo Pessoas</h6>'); ?>		
