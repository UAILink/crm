<div class="row-fluid">
    <div class="span4">
        <div class="actions well">
	        ...
	        <ul class="nav nav-list">
		        ...
		        <li><?php echo $this->Html->link(__('Novo Pessoas Iteração'), array('action' => 'add')); ?></li>        <li class='nav-header'><?php echo __('Pessoas'); ?></li>		<li><?php echo $this->Html->link(__('Listar Pessoas'), array('controller' => 'pessoas', 'action' => 'index')); ?></li> 
    ...
    <div class="span8" >
        <div class="pessoasIteracoes index">
