...
<div class="span4" >
    ...
    <ul class="nav nav-list">
      <li class='nav-header'><?php echo __('Ações'); ?></li>
		...
		<li><?php echo $this->Html->link(__('Editar Tipo Documento'), array('action' => 'edit', $tipoDocumento['TipoDocumento']['id']), array('class'=>'ym-button')); ?></li> 
		<li><?php echo $this->Form->postLink(__('Excluir Tipo Documento'), array('action' => 'delete', $tipoDocumento['TipoDocumento']['id']), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $tipoDocumento['TipoDocumento']['id'])); ?></li> 
		<li><?php echo $this->Html->link(__('Listar Tipo Documentos'), array('action' => 'index'), array('class'=>'ym-button')); ?></li> 
		<li><?php echo $this->Html->link(__('Novo Tipo Documento'), array('action' => 'add'), array('class'=>'ym-button')); ?></li> 
<li class='nav-header'><?php echo __('Pessoas Documentos'); ?></li>		<li><?php echo $this->Html->link(__('Listar Pessoas Documentos'), array('controller' => 'pessoas_documentos', 'action' => 'index'), array('class'=>'ym-button')); ?></li> 
		<li><?php echo $this->Html->link(__('Novo Pessoas Documento'), array('controller' => 'pessoas_documentos', 'action' => 'add'), array('class'=>'ym-button')); ?></li> 
</ul>
   </div>
</div>
