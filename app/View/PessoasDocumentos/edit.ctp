...
<div class="row">
    ...
    <div class="span4" >
        ...
        <li class='nav-header'><?php echo __('Ações'); ?></li>
        		        ...
        		        <li><?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('PessoasDocumento.id')), array('class'=>''), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('PessoasDocumento.id'))); ?></li>
...
<li class='nav-header'><?php echo __('Pessoas'); ?></li>		<li><?php echo $this->Html->link(__('Listar Pessoas'), array('controller' => 'pessoas', 'action' => 'index'), array('class'=>'')); ?></li> 
    ...
    <h4 class="ym-fbox-heading"><?php echo __('Editar Pessoas Documento'); ?></h4>
